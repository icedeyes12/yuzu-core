...
**Location:** `file yuzu-companion/app/tools/remote_fs_server.py`
...
**Location:** `file yuzu-companion/app/tools/fs_remote.py`
...
**Location:** `file yuzu-companion/app/tools/fs_client.py`
...
- [ ] Create `file remote_fs_server.py` with FastAPI
...
- [ ] Create `file fs_remote.py` tool module

- [ ] Register in `file registry.py`
