...
ADRs record accepted architectural decisions and their rationale. Accepted ADRs are immutable. If a decision changes, add a new ADR that explicitly supersedes the earlier one.

- [0001 — Reusable API response contract](0001-response-contract.md)
- [0002 — RFC 9457 errors](0002-rfc9457-errors.md)
- [0003 — API versioning](0003-api-versioning.md)
